...
const ViewTask = (props: IModal) => {
	...
	const countCompleted = newTask.subtasks?.filter(
		(item: ISubTask) => item.isCompleted === true
	)
			...
			<div className="ViewTask">
				<div className="ViewTask__topWrapper">
					...
					<DropDown
						...
						onEdit={() =>
							dispatch(
								openModal({ ModalType: "EditTask", ModalDetail: newTask })
							)
						}
				...
				<p className="ViewTask__descWrapper">
				...
				<div className="ViewTask__subtaskWrapper">
					...
					{ModalDetail.subtasks.length === 0 && (
						<p className="ViewTask__noSubTask">No subtasks.</p>
					)}
